...
- Read [../../rules-huayun-secondary-dev/stack-and-delivery.md](../../rules-huayun-secondary-dev/stack-and-delivery.md) for the full HUAYUN delivery contract.
- Read [../../rules-huayun-secondary-dev/11-workflow-phases.md](../../rules-huayun-secondary-dev/11-workflow-phases.md) for phase boundaries.
- Read [../../rules-huayun-secondary-dev/12-continuity-and-boundaries.md](../../rules-huayun-secondary-dev/12-continuity-and-boundaries.md) when continuing a previous design.
- Read [../../rules-huayun-secondary-dev/13-api-hard-constraints.md](../../rules-huayun-secondary-dev/13-api-hard-constraints.md) before inventing any platform behavior.
- Read [../../rules-huayun-secondary-dev/15-standard-architecture.md](../../rules-huayun-secondary-dev/15-standard-architecture.md) for default layering.
- Read [../../rules-huayun-secondary-dev/16-frontend-selection-matrix.md](../../rules-huayun-secondary-dev/16-frontend-selection-matrix.md) when deciding between plain frontend and Vue.
- Read [../../rules-huayun-secondary-dev/17-standard-scaffold-template.md](../../rules-huayun-secondary-dev/17-standard-scaffold-template.md) before creating new project structure.
- Read [../../rules-huayun-secondary-dev/20-authentication-and-security.md](../../rules-huayun-secondary-dev/20-authentication-and-security.md) for OAuth2 expectations.
- Read [../../rules-huayun-secondary-dev/30-common-response-contracts.md](../../rules-huayun-secondary-dev/30-common-response-contracts.md) for response handling.
- Read [../../rules-huayun-secondary-dev/40-document-management-api.md](../../rules-huayun-secondary-dev/40-document-management-api.md) for document APIs.
- Read [../../rules-huayun-secondary-dev/50-crownscript-api.md](../../rules-huayun-secondary-dev/50-crownscript-api.md) for supplemental CrownScript APIs.
- Read [../../rules-huayun-secondary-dev/60-folder-management-api.md](../../rules-huayun-secondary-dev/60-folder-management-api.md) for folder APIs.
- Read [../../rules-huayun-secondary-dev/70-drawing-api.md](../../rules-huayun-secondary-dev/70-drawing-api.md) for drawing APIs.
- Read [../../rules-huayun-secondary-dev/80-bom-api.md](../../rules-huayun-secondary-dev/80-bom-api.md) for BOM APIs.
- Read [../../rules-huayun-secondary-dev/90-topology-structure-and-query-api.md](../../rules-huayun-secondary-dev/90-topology-structure-and-query-api.md) for topology, structure, and query APIs.
- Read [../../../docs/huayun-secondary-dev-regression-test-cases.md](../../../docs/huayun-secondary-dev-regression-test-cases.md) when validating recent regressions.
