	...
	*/
	...
	async getStateToPostToWebview(): Promise<ExtensionState> {
		...
		return {
			...
			secondaryDevOAuthEnabled: secondaryDevOAuthEnabled ?? true,
	...
	> {
		...
		return {
			...
			secondaryDevBaseUrl: stateValues.secondaryDevBaseUrl ?? "",
			secondaryDevOAuthEnabled: stateValues.secondaryDevOAuthEnabled ?? true,
			secondaryDevClientId: stateValues.secondaryDevClientId ?? "",
			secondaryDevClientSecret: stateValues.secondaryDevClientSecret ?? "",
